...
impl DirectiveStatus {
    pub fn file_path(&self) -> &str {
        match &self.kind {
            ...
            DirectiveKind::HashlinePatch { file_path } => file_path,
    ...
    pub fn kind(&self) -> &'static str {
        match &self.kind {
            ...
            DirectiveKind::HashlinePatch { .. } => "HashlinePatch",
...
impl From<&FileDirective> for DirectiveStatus {
    fn from(directive: &FileDirective) -> Self {
        ...
        let kind = match directive {
            ...
            FileDirective::HashlinePatch { file_path, .. } => DirectiveKind::HashlinePatch {
                file_path: file_path.clone(),
            },
